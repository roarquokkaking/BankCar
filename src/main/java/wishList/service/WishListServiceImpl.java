...
public class WishListServiceImpl implements WishListService {
    ...
    @Override
    public int findByWishListIdAnduserId(String userId, Long wishlistId) {
        Optional<WishListEntity> findLike = wishListRepository.findByWishlistIdAndUserId(userId, wishlistId);
